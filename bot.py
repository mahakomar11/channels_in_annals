...
def handle_command(message):
    ...
    bot.send_message(
        ...
        "Если ты тоже иногда ловишь себя на том, что залипаешь в каналы, когда этого не хотел, я могу быть полезным. "
...
def get_message(message):
    ...
    if message.text == "Инструкция":
        answer = (
            ...
            'Если я не могу достать ссылку на канал, нажми "Добавить вручную".'
        )
